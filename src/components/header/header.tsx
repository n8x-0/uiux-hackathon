...
const routes = [
    { name: "New & Featured", route: "/products" },
    { name: "Men", route: "/products/men's" },
    { name: "Women", route: "/products/women's" },
    { name: "Kids", route: "/products/kid's" },
    { name: "Sale", route: "/products/sale" },
    { name: "SNKRS", route: "/feed" },
];
                ...
                <div className="w-full sm:py-4 sm:px-10 px-2 py-2 flex justify-between items-center border-b m-auto relative">
                    ...
                    <div className="flex justify-center items-center md:gap-6 gap-3">
                        <div className="relative xs:block hidden">
                            <input
                                type="text"
                                className="px-4 py-2 bg-[#F5F5F5] rounded-3xl placeholder:text-sm sm:w-64 w-56 focus:outline-none pl-10"
